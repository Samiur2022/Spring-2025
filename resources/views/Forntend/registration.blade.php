        ...
        <form action="{{ route('customer.submit')}}" method="post">
            ...
            <div class="user_details">
                ...
                <div class="input_box">
                    ...
                    <input type="password" name="password_confirmation" id="confirmPass" placeholder="Confirm your password" required>
                </div>
            </div>
            <div class="gender">
                ...
                <input type="radio" name="gender" value="none" id="radio_3">
